...
export const DELETE_PROPERTY = "/me/properties";
export const PUBLISH_PROPERTY = "/me/properties";
export const MARK_SOLD_PROPERTY = "/me/properties";
export const UPLOAD_PROPERTY_MEDIA = "/me/properties";
export const DELETE_PROPERTY_MEDIA = "/me/properties";
export const REORDER_PROPERTY_MEDIA = "/me/properties";

// Inquiries
export const CREATE_INQUIRY = "/public/properties";
export const GET_BUYER_INQUIRY = "/public/inquiries";
export const UPDATE_BUYER_INQUIRY = "/public/inquiries";
export const ADD_BUYER_MESSAGE = "/public/inquiries";
export const GET_AGENT_INQUIRIES = "/me/inquiries";
export const UPDATE_AGENT_INQUIRY = "/me/inquiries";
export const ADD_AGENT_MESSAGE = "/me/inquiries";
