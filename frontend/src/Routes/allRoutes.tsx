...
// Properties
import CreateEditProperty from "../pages/Properties/CreateEditProperty/index";
...
const authProtectedRoutes = [
  ...
  { path: "/properties/new", component: <CreateEditProperty /> },
  { path: "/properties/:id/edit", component: <CreateEditProperty /> },
  // //Crm
